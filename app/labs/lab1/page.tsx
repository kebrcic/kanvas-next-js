  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        How to make a grill over charcoal
        <ol id="wd-your-favorite-recipe">
          <li>Season meat</li>
          <li>Clean and Prep</li>
          <li>Stack the Charcoal</li>
          <li>Light it Safely</li>
          <li>Wait for Ash</li>
          <li>Spread and Preheat</li>
        </ol>
      ...
      <div id="wd-forms">
        ...
        <br />
        <input id="wd-radio-comedy" type="radio" name="radio-genre" />
        ...
        to get dummy text
        <br />
        <a href="https://github.com/kebrcic/kanvas-next-js" id="wd-github">
          Github
        </a>
        <br />
      </div>
